...
import { Home, Package, Milk, Plus, X, Edit2, Trash2, Check } from 'lucide-react'
...
export default function TraceabilityPage() {
  ...
  // Load data when tab changes or user loads
  useEffect(() => {
    if (!userId) return
  ...
  }, [userId, activeTab, fetchContainers, fetchBatches, fetchAvailableHarvests])
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {showContainerForm && activeTab === 'containers' && (
          <div className="mb-6 bg-surface rounded-xl p-4 border border-border shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-semibold">
                {editingContainer ? 'Edit Container' : 'New Container'}
              </h2>
              <button onClick={resetContainerForm} className="p-2 hover:bg-surface-elevated rounded-lg">
                <X size={20} />
              </button>
            </div>
        ...
        {showBatchForm && activeTab === 'batches' && (
          <div className="mb-6 bg-surface rounded-xl p-4 border border-border shadow-sm">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={resetBatchForm} className="p-2 hover:bg-surface-elevated rounded-lg">
                <X size={20} />
              </button>
            </div>
