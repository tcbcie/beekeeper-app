                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-sage-200 dark:bg-sage-800 text-foreground rounded-lg hover:bg-sage-300 dark:hover:bg-sage-700 transition-colors min-h-[48px]"
                    >
                      −
                    </button>
                    <input
                      ...
                      className="flex-1 px-4 py-2 min-h-[48px] border border-border rounded-lg bg-surface dark:bg-surface-elevated text-foreground text-center text-xl font-semibold focus:border-forest-500 focus:ring-2 focus:ring-forest-500"
                      step="1"
                      min="1"
                    />
                    <button
