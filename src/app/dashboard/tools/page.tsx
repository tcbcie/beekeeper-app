...
import { Wrench, Droplet, Cookie, Cloud, Send, Calculator } from 'lucide-react'
...
type ToolsSection = 'calculators' | 'analysis' | 'other'

export default function ToolsPage() {
  const [userId, setUserId] = useState<string | null>(null)
  const [activeSection, setActiveSection] = useState<ToolsSection>('calculators')
  ...
  useEffect(() => {
    ...
    if (section && ['calculators', 'analysis', 'other'].includes(section)) {
  ...
  const sections = [
    ...
    { id: 'analysis' as const, label: 'Analysis', icon: Cloud },
    { id: 'other' as const, label: 'Other', icon: Wrench },
  ]
