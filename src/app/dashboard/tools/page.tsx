...
import { Wrench, Droplet, Cookie, Thermometer, Cloud, Grid3X3, Send, Camera, Wallet } from 'lucide-react'
...
export default function ToolsPage() {
  ...
  const tools = [
    ...
    },
    {
      icon: Wallet,
      title: 'P&L',
      description: 'Track your beekeeping income and expenses',
      status: 'Available',
      onClick: () => setActiveTool(activeTool === 'profitloss' ? null : 'profitloss')
    }
  ]
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {tools.map((tool, index) => (
          <div key={index}>
            ...
            {/* P&L Tool */}
            {tool.title === 'P&L' && activeTool === 'profitloss' && (
              <div className="mt-4 bg-surface dark:bg-surface rounded-lg shadow-lg p-6 border border-forest-300 dark:border-forest-700">
