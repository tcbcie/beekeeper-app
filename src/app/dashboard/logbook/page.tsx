      ...
      {LOGBOOK_STAGES.length > 1 && (
        <div className="mb-4">
          <select
            ...
            className="w-full sm:w-auto px-3 py-2 text-sm rounded-lg border border-border bg-white dark:bg-gray-900 text-foreground focus:ring-2 focus:ring-forest-500 focus:border-transparent"
          >
                    ...
                    return (
                      <div key={skill.id}>
                        <button
                          ...
                          className={`w-full flex items-start gap-3 p-3 px-4 text-left hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors border-b border-border last:border-b-0 ${
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <input
                                  ...
                                  maxLength={200}
                                  className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-white dark:bg-gray-900 text-foreground focus:ring-2 focus:ring-forest-500 focus:border-transparent"
                              ...
                              <div>
                                ...
                                <textarea
                                  ...
                                  rows={2}
                                  className="w-full px-3 py-2 text-sm rounded-lg border border-border bg-white dark:bg-gray-900 text-foreground focus:ring-2 focus:ring-forest-500 focus:border-transparent resize-none"
                              ...
                              <div className="flex gap-2">
                                ...
                                <button
                                  ...
                                  className="px-4 py-2 text-sm font-medium text-text-secondary border border-border rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                                >
                                  Cancel
                                </button>
                              </div>
