        ...
        <div className="flex items-start gap-2 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <span className="px-2 py-0.5 bg-yellow-100 text-yellow-900 dark:bg-yellow-900/45 dark:text-yellow-100 border border-yellow-200 dark:border-yellow-700/60 text-sm font-medium rounded">
                Feeding
              </span>
