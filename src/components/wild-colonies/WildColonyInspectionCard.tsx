        ...
        <div className="flex-1 min-w-0">
            ...
            {inspection.colony_status && (
              <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${
                inspection.colony_status === 'active' || inspection.colony_status === 'strong'
                  ...
                  ? 'bg-amber-100 text-gray-900 dark:bg-amber-900/30 dark:text-amber-300'
          ...
          <div className="flex flex-wrap gap-1.5 mt-2">
            {inspection.pollen_observed && (
              <span className="px-2 py-0.5 text-xs bg-yellow-100 text-gray-900 dark:bg-yellow-900/30 dark:text-yellow-300 rounded">
                Pollen
              </span>
            )}
            {inspection.drones_observed && (
              <span className="px-2 py-0.5 text-xs bg-blue-100 text-gray-900 dark:bg-blue-900/30 dark:text-blue-300 rounded">
                Drones
              </span>
            )}
            {inspection.orientation_flights && (
              <span className="px-2 py-0.5 text-xs bg-purple-100 text-gray-900 dark:bg-purple-900/30 dark:text-purple-300 rounded">
                Orientation Flights
              </span>
            )}
            {inspection.robbing_activity && (
              <span className="px-2 py-0.5 text-xs bg-orange-100 text-gray-900 dark:bg-orange-900/30 dark:text-orange-300 rounded">
                Robbing
              </span>
            )}
            {inspection.swarm_activity_observed && (
              <span className="px-2 py-0.5 text-xs bg-pink-100 text-gray-900 dark:bg-pink-900/30 dark:text-pink-300 rounded">
                Swarm Activity
              </span>
            )}
          </div>
