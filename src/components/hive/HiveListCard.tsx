        ...
        <div className="flex items-center gap-2">
          ...
          {!hive.archived_at && (
            daysSinceInspection !== null ? (
              ...
              <span className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded border bg-sage-100 dark:bg-slate-700 text-text-secondary border-border">
                <Clock size={10} />
                Never
              </span>
            )
