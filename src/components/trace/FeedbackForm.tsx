...
export default function FeedbackForm({ traceCode }: FeedbackFormProps) {
 ...
 if (isSubmitted) {
 return (
 <div className="bg-surface-elevated rounded-2xl shadow-lg border border-green-100 dark:border-green-900 p-6 text-center">
 ...
 return (
 <div className="bg-surface-elevated rounded-2xl shadow-lg border border-amber-100 p-6">
 ...
 tone="amber"
 fullWidth
 className="py-3 px-4 rounded-xl font-medium disabled:opacity-50 disabled:cursor-not-allowed"
 >
 {isSubmitting ? (
