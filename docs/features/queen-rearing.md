...
- The top summary area is presented as a planning snapshot, separating anchor dates from wider mating and laying windows instead of forcing every item into the same card shape
