...
--    (linked to beekeeping_associations table)
...
BEGIN
  ...
  -- Check for orphaned association codes (association_id points to non-existent association)
  DECLARE
...
-- Show association codes with their associations
SELECT
  rc.code,
  rc.code_type,
...
BEGIN
  ...
  RAISE NOTICE '  1. Update frontend to support both code types';
  RAISE NOTICE '  2. Add association selector to code creation form';
