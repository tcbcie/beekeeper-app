-- ============================================================================
-- PERMANENTLY DELETE SOFT-DELETED USERS AND ALL THEIR DATA
-- ============================================================================
...
BEGIN
  ...
  INTO total_hives, total_inspections, total_queens
  FROM profiles p
  ...
  LOOP
    ...
    RAISE NOTICE '  Data: % hives, % inspections, % queens',
                 user_record.hive_count, user_record.inspection_count, user_record.queen_count;
    RAISE NOTICE '';
  END LOOP;
...
-- ============================================================================
-- DELETION BLOCK - DELETE USERS AND ALL THEIR DATA
-- ============================================================================
DO $$
DECLARE
...
BEGIN
  ...
  LOOP
    ...
    -- 12. Delete subscription history
