...
-- ============================================================================
-- Add the 'code' column to the INSERT statement for subscription_history
-- For credit card payments, both code_id and code should be NULL
-- ============================================================================
...
BEGIN
  ...
  -- For credit card payments: code_id is NULL, code is NULL
  INSERT INTO public.subscription_history (
    ...
    p_user_id,
    NULL,  -- No code_id for credit card payments
    NULL,  -- No code for credit card payments
    NOW(),
    new_expiry,
    365,
    'credit_card',
...
BEGIN
  ...
  RAISE NOTICE '✅ Now includes code column (NULL for credit card payments)';
