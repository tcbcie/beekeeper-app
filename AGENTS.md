...
* **Task Management:** Write a step-by-step plan to `tasks/todo.md` with checklist items `[ ]`.
...
* **Execution:** Once approved, work through the items one by one, updating `tasks/todo.md` to `[x]` as you complete them. Provide a high-level explanation to me at every step.
* **Review Summary:** Upon completion, append a "Review" section to `tasks/todo.md` summarizing the changes made and any relevant context.
...
* **Completeness:** Act as a Senior Developer. Provide complete, production-ready code. Find and fix the root causes of bugs rather than applying temporary patches. Never use placeholders, stubs, or `// TODO` comments in your generated code.
...
* **Template:** When generating your plan in tasks/todo.md, always use the structure provided in tasks/todo-template.md
